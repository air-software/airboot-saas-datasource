...
import com.airboot.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    private static final Pattern REGEX_USERNAME = Pattern.compile("^[a-zA-Z]\\w{2,19}$");
    ...
    /**
     * 将 snake_case（下划线分隔命名法）转换为 PascalCase（帕斯卡命名法）
     * 例如：hello_world -> HelloWord
     *
     * @param name snake_case string
     * @return PascalCase string
     */
    public static String snakeToPascalCase(String name) {
    ...
    public static boolean isChinese(String str){
        ...
        return REGEX_CHINESE.matcher(str).matches();
    }
